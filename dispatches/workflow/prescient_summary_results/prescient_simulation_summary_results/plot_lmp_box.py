...
# this could also just be all of the prescient results
base_dir = os.path.join(this_file_dir(),"prescient_sweep_subset/pmax_433")
...
lmp_plt.set_xlabel("")
plt.tight_layout()
plt.legend(loc=2, prop={'size': 24},title = "Marginal Cost [$/MWh]",ncol=3)
