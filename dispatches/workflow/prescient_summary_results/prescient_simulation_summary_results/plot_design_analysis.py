...
axs.set_ylabel("Revenue [$MM]")
for i in range(5):
    plt.scatter(mrg_csts,revenues_pmax_mid[i], s = 150, alpha = 0.75, color = colors[i])
...
axs.legend(handles=legend_elements, loc='lower left', prop={'size': 28})
plt.tight_layout()
plt.savefig("revenue_mrg_cst_sweep_pmax_mid.png")
plt.savefig("revenue_mrg_cst_sweep_pmax_mid.pdf")
...
axs.set_ylabel("Capacity Factor")
for i in range(5):
    plt.scatter(mrg_csts,cap_factors_pmax_mid[i], s = 150, alpha = 0.75, color = colors[i])
...
axs.legend(handles=legend_elements, loc='lower left', prop={'size': 28})
plt.tight_layout()
plt.savefig("capfactor_mrg_cst_sweep_pmax_mid.png")
plt.savefig("capfactor_mrg_cst_sweep_pmax_mid.pdf")
