...
#folder = 'scikit_run_0'
folders = ['alamo_run_0','scikit_run_1','scikit_run_2']
for folder in folders:
	coal_price = 30.0
	startup_cost = 61.09

	if folder == 'scikit_run_2':
		coal_price = 50.0

	with open('_verification_runs/{}/verification_inputs.json'.format(folder), 'r') as infile:
