...
if __name__ == '__main__':
    ...
    data1 = {
        ...
        "flow_mol_discharge": 0.0000958 / 18.01528,
        "inlet_pressure_discharge": 0.4e6, #15 MPa
        "inlet_temperature_discharge": 279
        }
    ...
    m.fs.tes = ConcreteTES(default={"model_data": data1, "property_package": m.fs.props_water})
